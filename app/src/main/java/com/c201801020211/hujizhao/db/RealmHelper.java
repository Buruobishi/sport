package com.c201801020211.hujizhao.db;

import com.c201801020211.hujizhao.commmon.bean.SportMotionRecord;
import com.c201801020211.hujizhao.commmon.bean.UserAccount;
import com.c201801020211.hujizhao.commmon.utils.Utils;
...
public class RealmHelper implements DBHelper {
    ...
    private static final String DB_SPORT = "sport_zi.realm";//数据库名
    private static final String DB_ACCOUNT = "account.realm";//数据库账号名
    private static final String DB_KEY = "2018010202111111";//秘钥
