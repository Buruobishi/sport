...
import com.c201801020211.hujizhao.commmon.utils.DateUtils;
...
import com.c201801020211.hujizhao.ui.adapter.SportCalendarAdapter;
import com.c201801020211.hujizhao.ui.weight.calendarview.custom.CustomWeekBar;
...
public class HomeActivity extends BaseActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        SpannableString spannableString1=new SpannableString(string);
        ...
        try {
            ...
            if (null != records) {
                ...
                for (SportMotionRecord record : records) {
                    ...
                    map.put(getSchemeCalendar(year, month, day, "记").toString(),
                            getSchemeCalendar(year, month, day, "记"));
                }
    ...
    private Calendar getSchemeCalendar(int year, int month, int day, String text) {
        ...
        calendar.setDay(day);
        calendar.setSchemeColor(-3407872);//如果单独标记颜色、则会使用这个颜色
